    ...
    >
      ...
      >
        <input
          ...
          className="w-full rounded-full px-4 py-1.5 text-sm outline-none focus:ring-2 focus:ring-[#6040d1]"
          style={{
            ...
            {user ? (
              <>
                ...
                <Link
                  href="/post"
                  id="header-post-btn"
                  className="text-sm rounded-lg px-3 py-1.5 font-medium text-white transition"
                ...
                <button
                  ...
                  className="text-sm rounded-lg px-3 py-1.5 font-medium border transition cursor-pointer"
                  style={{
                    borderColor: '#d7d5dc',
                    color: '#dc2626',
                    backgroundColor: '#ffffff',
        ...
        >
          <form onSubmit={handleSearch}>
            <input
              ...
              type="search"
              placeholder="Search deals…"
              className="w-full rounded-full px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-[#6040d1]"
              style={{
                border: '1px solid #d7d5dc',
                backgroundColor: '#f2f3fb',
                color: '#000',
